      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <p className="max-w-2xl text-lg font-light mb-8">
            Gain insights into your product performance and customer preferences
          </p>
          <Button className="bg-white text-black border-0 hover:bg-gray-100">
            EXPLORE REPORTS <ArrowRight className="ml-2 h-4 w-4" />
          </Button>
        </div> 
      </section>

      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <h1 className="text-4xl md:text-6xl font-light tracking-tighter">ANALYTICS</h1>
