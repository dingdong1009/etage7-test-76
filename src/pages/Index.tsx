          ...
          <div className="max-w-3xl" ref={buyerContentRef}>
            {!showBuyerInfo ? <>
                ...
                <div className="mb-12">
                  ...
                  <div className="max-w-3xl">
                    <p className="text-lg md:text-xl font-light text-black-100 mb-12 max-w-2xl">
                    ÉTAGE7 represents aspirational premium and luxury brands, catering to a discerning clientele who value rarity and prestige and maintain an aura of exclusivity. <Link to="/curated" className="text-gray-600 hover:text-black flex items-center gap-2 transition-fast">Discover our brands <ArrowRight className="ml-2 h-4 w-4" strokeWidth={1} /></Link>.</p> 
