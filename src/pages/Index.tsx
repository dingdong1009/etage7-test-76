  ...
  return (
    <div className="w-full">
      ...
      <section className="relative h-screen bg-black text-white flex items-center">
        ...
        >
          <span className="text-sm mb-2 animate-bounce">Learn more as a Brand</span>
          <ChevronDown size={24} className="animate-bounce" />
        </button>
      </section>

      {/* Brands Section */}
      <section id="brand" className="relative h-screen bg-grey text-black flex items-center">
        <div className="container-lg">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-light tracking-tighter mb-6">
              CONNECTING<br/>
