            ...
            {!showBuyerInfo ? <>
                ...
                <div className="mb-12">
                  ...
                  <div className="max-w-3xl">
                    ...
                    <p><Link to="/curated" className="text-gray-600 hover:text-black flex items-center gap-2 transition-fast">Discover our brands <ArrowRight className="ml-2 h-4 w-4" strokeWidth={1} /></Link></p> 
