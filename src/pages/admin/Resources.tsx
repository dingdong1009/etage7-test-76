...
import { FileText, Youtube, Book, Download, ExternalLink, Play, Search, Plus } from "lucide-react";
...
const AdminResources = () => {
  ...
  // Sample resources
  const pdfResources = [
    { id: 1, title: "Buyer's Guide", description: "Complete guide for using the buyer platform", size: "2.4 MB", link: "", category: "guide" },
    { id: 2, title: "Ordering Toolkit", description: "Templates and guides for your ordering process", size: "5.1 MB", link: "https://example.com/ordering-toolkit.pdf", category: "toolkit" },
    { id: 3, title: "Product Selection Guidelines", description: "How to select products for your store", size: "1.8 MB", link: "", category: "guide" },
    { id: 4, title: "Merchandising Playbook", description: "Effective strategies for merchandising", size: "3.2 MB", link: "https://example.com/merchandising.pdf", category: "playbook" }
  ];

  const videoResources = [
    { id: 1, title: "Introduction to the Buyer Platform", duration: "4:32", link: "https://youtube.com/watch?v=example1", category: "tutorial" },
    { id: 2, title: "Order Placement Tutorial", duration: "7:15", link: "", category: "tutorial" },
    { id: 3, title: "Analyzing Your Inventory Data", duration: "12:08", link: "https://vimeo.com/example3", category: "analysis" },
    { id: 4, title: "Visual Merchandising Tips", duration: "9:45", link: "", category: "tips" }
  ];

  const externalResources = [
    { id: 1, title: "Retail Trends Report", source: "Fashion Weekly", type: "article", link: "https://fashionweekly.com/trends", category: "trends" },
    { id: 2, title: "Store Management Best Practices", source: "Retail Insights", type: "webinar", link: "", category: "management" },
    { id: 3, title: "Buyer Growth Strategies", source: "Marketing Pros", type: "course", link: "https://marketingpros.com/courses/growth", category: "growth" },
    { id: 4, title: "Inventory Management", source: "Business Daily", type: "article", link: "https://businessdaily.com/inventory", category: "inventory" }
  ];
  ...
  return (
    <div className="space-y-6">
      <Tabs defaultValue="all" className="w-full">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4 items-start sm:items-center pb-4">
