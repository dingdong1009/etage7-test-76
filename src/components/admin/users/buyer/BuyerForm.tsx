...
const BuyerForm = ({ initialData, onSubmit, onCancel, isEdit = false }: BuyerFormProps) => {
  const form = useForm({
    defaultValues: {
      id: initialData?.id || 0,
      ...
      storeCount: initialData?.storeCount || 0,
      activeSince: initialData?.activeSince || "",
      avgOrderValue: initialData?.avgOrderValue || "",
      annualPurchases: initialData?.annualPurchases || "",
    }
  });
