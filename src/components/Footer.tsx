  ...
  return (
    <footer className="bg-white pt-16 pb-8">
      <div className="container-lg relative">
        <div className="absolute top-[-4rem] left-0 right-0 mx-auto max-w-[1481px] h-px bg-gray-100"></div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-16 pt-8 border-t border-gray-100 max-w-[1481px] mx-auto">
