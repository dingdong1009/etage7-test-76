...
const mockFollowers = [
  ...
  { id: 3, name: "Saks Fifth Avenue", email: "buyer@saks.com", location: "New York, USA", followedDate: "2025-02-28", avatar: "" },
  { id: 4, name: "Le Bon Marché", email: "buyer@lbm.com", location: "Paris, France", followedDate: "2025-02-20", avatar: "" },
  { id: 5, name: "Harrods", email: "buyer@harrods.com", location: "London, UK", followedDate: "2025-02-15", avatar: "" },
];

const mockLikes = [
  { id: 1, name: "Galeries Lafayette", productName: "Silk Blouse - White", likedDate: "2025-03-16", avatar: "" },
  { id: 2, name: "Selfridges", productName: "Wool Coat - Black", likedDate: "2025-03-14", avatar: "" },
  { id: 3, name: "Neiman Marcus", productName: "Leather Pants - Brown", likedDate: "2025-03-12", avatar: "" },
  { id: 4, name: "Harrods", productName: "Cashmere Sweater - Gray", likedDate: "2025-03-10", avatar: "" },
  { id: 5, name: "Bloomingdale's", productName: "Silk Scarf - Patterned", likedDate: "2025-03-08", avatar: "" },
];

const mockCarts = [
  { id: 1, name: "Galeries Lafayette", productName: "Silk Blouse - White", quantity: 10, addedDate: "2025-03-17", avatar: "" },
  { id: 2, name: "Selfridges", productName: "Wool Coat - Black", quantity: 5, addedDate: "2025-03-14", avatar: "" },
  { id: 3, name: "Neiman Marcus", productName: "Leather Pants - Brown", quantity: 8, addedDate: "2025-03-13", avatar: "" },
  { id: 4, name: "Harrods", productName: "Cashmere Sweater - Gray", quantity: 12, addedDate: "2025-03-11", avatar: "" },
  { id: 5, name: "Le Bon Marché", productName: "Evening Gown - Black", quantity: 3, addedDate: "2025-03-09", avatar: "" },
];

const mockVisits = [
  { id: 1, name: "Galeries Lafayette", visitDate: "2025-03-17", pageViews: 12, avatar: "" },
  { id: 2, name: "Selfridges", visitDate: "2025-03-16", pageViews: 8, avatar: "" },
  { id: 3, name: "Neiman Marcus", visitDate: "2025-03-15", pageViews: 5, avatar: "" },
  { id: 4, name: "Harrods", visitDate: "2025-03-14", pageViews: 10, avatar: "" },
  { id: 5, name: "Bloomingdale's", visitDate: "2025-03-13", pageViews: 7, avatar: "" },
];
