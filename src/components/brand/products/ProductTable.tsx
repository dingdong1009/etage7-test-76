          ...
          <TableBody>
            {products.length === 0 ? (
              ...
              products.map((product) => (
                <TableRow key={product.id} className="hover:bg-gray-50/80 cursor-pointer">
                  <TableCell className="font-medium" onClick={() => openQuickView(product)}>{product.name}</TableCell>
                  <TableCell onClick={() => openQuickView(product)}>{product.sku}</TableCell>
                  <TableCell onClick={() => openQuickView(product)}>{product.category}</TableCell>
                  <TableCell className="hidden md:table-cell" onClick={() => openQuickView(product)}>{product.season}</TableCell>
                  ...
                  <TableCell className="text-right" onClick={() => openQuickView(product)}>${product.price.toFixed(2)}</TableCell>
                  <TableCell onClick={() => openQuickView(product)}>
